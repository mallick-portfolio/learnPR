    ...
    <>
      ...
      <ul>
        {events.map((event) => (
          <li
            key={event.id}
            className="bg-[#f0efe9] p-4 pl-10 my-4 ml-8 rounded-md shadow-xl relative"
          >
            ...
            <p>{event.des}</p>
            <div className="absolute rounded-md top-1/2 -translate-y-1/2 -left-8 bg-primary px-4 py-2">
